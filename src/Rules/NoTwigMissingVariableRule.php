...
final class NoTwigMissingVariableRule implements Rule
{
    ...
    /**
     * @var \Reveal\TwigPHPStanCompiler\NodeAnalyzer\MissingTwigTemplateRenderVariableResolver
     */
    private $missingTwigTemplateRenderVariableResolver;
    /**
     * @var \Reveal\RevealTwig\NodeAnalyzer\SymfonyRenderWithParametersMatcher
     */
    private $symfonyRenderWithParametersMatcher;

    public function __construct(MissingTwigTemplateRenderVariableResolver $missingTwigTemplateRenderVariableResolver, SymfonyRenderWithParametersMatcher $symfonyRenderWithParametersMatcher)
    {
        $this->missingTwigTemplateRenderVariableResolver = $missingTwigTemplateRenderVariableResolver;
